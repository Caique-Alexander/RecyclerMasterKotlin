    ...
    inner class EmailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(email: Email) {
            with(email) {
                ...
                itemView.findViewById<TextView>(R.id.txt_icon)
                    .text = user.first().toString()
                itemView.findViewById<TextView>(R.id.txt_icon)
                    .background =
                    itemView.oval(Color.rgb(hash, hash / 2, 0))
                ...
                itemView.findViewById<TextView>(R.id.txt_subject)
                    .setTypeface(Typeface.DEFAULT, if (unread) BOLD else NORMAL)
                itemView.findViewById<TextView>(R.id.txt_date)
                    .setTypeface(Typeface.DEFAULT, if (unread) BOLD else NORMAL)
